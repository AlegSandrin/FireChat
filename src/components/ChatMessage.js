        ...
        <div className={`div${messageClass} ml-2 opacity-90`}>
          ...
          >
            ...
            <div>
              ...
              {imageURL && (
                <img
                  className="mx-auto max-h-[250px] max-w-full cursor-pointer p-2 transition hover:brightness-110"
                  src={imageURL}
                  onClick={() => {
                    setOpen(true);
                  }}
              ...
              {videoURL && (
                <div className="transition flex justify-center items-center hover:text-[#cc264af6] hover:brightness-110 w-auto h-auto">
